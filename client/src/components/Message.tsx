  ...
  return (
    <>
      <ShowMessages
        ...
        username={username}
      />
      <div className="gap-2 rounded-md  bg-gray-900 w-full flex ">
        <input
          type="text"
          ref={messageRef}
        ...
        />
        <button
          className="px-4 flex items-center gap-1 py-2   bg-black border-2 border-red-500 text-white rounded-lg "
          onClick={handleSendMessage}
        >
          Send
          <RiSendPlaneFill className="text-green-400" />
        </button>
      </div>
    </>
  );
